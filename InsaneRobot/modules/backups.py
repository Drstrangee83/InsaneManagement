...
# from InsaneRobot.modules.sql import warns_sql as warnssql
import InsaneRobot.modules.sql.blacklist_sql as blacklistsql

# from InsaneRobot.modules.sql import cust_filters_sql as filtersql
# import InsaneRobot.modules.sql.welcome_sql as welcsql
import InsaneRobot.modules.sql.locks_sql as locksql
import InsaneRobot.modules.sql.notes_sql as sql

# from InsaneRobot.modules.rules import get_rules
import InsaneRobot.modules.sql.rules_sql as rulessql
from InsaneRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from InsaneRobot.__main__ import DATA_IMPORT
from InsaneRobot.modules.connection import connected
from InsaneRobot.modules.helper_funcs.alternate import typing_action
from InsaneRobot.modules.helper_funcs.chat_status import user_admin
from InsaneRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("InsaneRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("InsaneRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `InsaneRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("InsaneRobot{}.backup".format(chat_id))  # Cleaning file
