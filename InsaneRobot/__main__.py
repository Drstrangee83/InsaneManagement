...
import InsaneRobot.modules.sql.users_sql as sql
from InsaneRobot import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
    OWNER_ID,
...
from InsaneRobot.modules import ALL_MODULES
from InsaneRobot.modules.helper_funcs.chat_status import is_user_admin
from InsaneRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="❄ ᴀʙᴏᴜᴛ ❄", callback_data="Insane_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("InsaneRobot.modules." + module_name)
...
@run_async
def Insane_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="Insane_support"
                        ),
                        InlineKeyboardButton(
    ...
    elif query.data == "Insane_support":
        query.message.edit_text(
...
© 2022 - 2023 [@ᴅᴏsᴛᴏ_ᴋɪ_ᴍᴇʜꜰɪʟ786](https://t.me/{SUPPORT_CHAT}), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
┗•❅────✧❅✦❅✧────❅•┛""",
    ...
    about_callback_handler = CallbackQueryHandler(
        Insane_about_callback, pattern=r"Insane_"
    )
